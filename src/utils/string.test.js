...
describe("String Utils", () => {
  ...
  describe("convert case individual utils", () => {
    ...
    it("convertToKebabCase", () => {
      assert.strictEqual(
        convertToKebabCase("kebab-to-kebab"),
        "kebab-to-kebab"
      );
      assert.strictEqual(
        convertToKebabCase("snake_to_kebab"),
        "snake-to-kebab"
      );
      assert.strictEqual(
        convertToKebabCase("PascalToKebab"),
        "pascal-to-kebab"
      );
    ...
    it("convertToSnakeCase", () => {
      assert.strictEqual(
        convertToSnakeCase("kebab-to-snake"),
        "kebab_to_snake"
      );
      assert.strictEqual(
        convertToSnakeCase("snake_to_snake"),
        "snake_to_snake"
      );
      assert.strictEqual(
        convertToSnakeCase("PascalToSnake"),
        "pascal_to_snake"
      );
